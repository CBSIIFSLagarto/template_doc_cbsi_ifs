...
%% para o curso de Bacharelado em Sistemas de Informação do           %%
%% Instituto Federal de Educação, Ciência e Tecnologia de Sergipe IFS %%
%% criada por Gilson Pereira	                                      %%
%% e atualizada por Francisco Rodrigues								  %%	
%% baseado na customização da Universidade Estadual do Ceara - UECE   %%
%% criada por Thiago Nascimento (versão @6e662036 de 22/02/2017)      %%
%%                                                                    %%
